...
async def run(bot, message, args):
    ...
    if (args[1]+".csv") not in liste_csv:
    ...
    if args[0] == "add":
        ...
        await message.channel.send(f"Euh... j'ai aucune commande pour {args[0]} désolé ^^'")